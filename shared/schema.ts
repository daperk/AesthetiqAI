...
export const appointmentStatusEnum = pgEnum("appointment_status", ["pending", "scheduled", "confirmed", "in_progress", "completed", "canceled", "no_show", "cancellation_requested"]);
